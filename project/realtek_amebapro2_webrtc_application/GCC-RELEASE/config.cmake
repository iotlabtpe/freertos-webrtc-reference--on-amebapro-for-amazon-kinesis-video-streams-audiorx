...
if(NOT DEFINED CONFIG_DONE)
	...
	if(MPCHIP)
		...
		elseif(MACOS)
			if(MACOS_ARM)
			set(ELF2BIN ${sdk_prj_example_root}/GCC-RELEASE/mp/elf2bin.arm.darwin)
			else()
			set(ELF2BIN ${sdk_prj_example_root}/GCC-RELEASE/mp/elf2bin.darwin)
			endif()
		else()
		...
		if (LINUX)
		set(ELF2BIN ${sdk_prj_example_root}/GCC-RELEASE/testchip/elf2bin.linux)
		else()
		set(ELF2BIN ${sdk_prj_example_root}/GCC-RELEASE/testchip/elf2bin.exe)
		endif()
	endif()
	endif()		
	...
	if(MPCHIP)
		if (LINUX)
		set(CHKSUM ${sdk_prj_example_root}/GCC-RELEASE/mp/checksum.linux)
		elseif(MACOS)
			if(MACOS_ARM)
			set(CHKSUM ${sdk_prj_example_root}/GCC-RELEASE/mp/checksum.arm.darwin)
			else()
			set(CHKSUM ${sdk_prj_example_root}/GCC-RELEASE/mp/checksum.darwin)
			endif()
		else()		
		set(CHKSUM ${sdk_prj_example_root}/GCC-RELEASE/mp/checksum.exe)
		endif()
	endif()
	endif()		
	...
	if(MPCHIP)
		if (LINUX)
		set(NNMDLCFG ${sdk_prj_example_root}/GCC-RELEASE/mp/nn_model_cfg.linux)
		elseif(MACOS)
			if(MACOS_ARM)
			set(NNMDLCFG ${sdk_prj_example_root}/GCC-RELEASE/mp/nn_model_cfg.arm.darwin)
			else()
			set(NNMDLCFG ${sdk_prj_example_root}/GCC-RELEASE/mp/nn_model_cfg.darwin)
			endif()
		else()		
		set(NNMDLCFG ${sdk_prj_example_root}/GCC-RELEASE/mp/nn_model_cfg.exe)
		endif()
	endif()
	endif()		
	...
	if(MPCHIP)
		if (LINUX)
		set(GENSNRLST ${sdk_prj_example_root}/GCC-RELEASE/mp/gen_snrlst.linux)
		elseif(MACOS)
			if(MACOS_ARM)
			set(GENSNRLST ${sdk_prj_example_root}/GCC-RELEASE/mp/gen_snrlst.arm.darwin)
			else()
			set(GENSNRLST ${sdk_prj_example_root}/GCC-RELEASE/mp/gen_snrlst.darwin)
			endif()
		else()		
		set(GENSNRLST ${sdk_prj_example_root}/GCC-RELEASE/mp/gen_snrlst.exe)
		endif()
	endif()
	endif()		
	...
	if (MPCHIP)
		set(POSTBUILD_BOOT		${sdk_prj_example_root}/GCC-RELEASE/mp/amebapro2_bootloader.json)
		set(POSTBUILD_FW_NTZ 	${sdk_prj_example_root}/GCC-RELEASE/mp/amebapro2_firmware_ntz.json)
		set(POSTBUILD_FW_NTZXIP	${sdk_prj_example_root}/GCC-RELEASE/mp/amebapro2_firmware_ntz_xip.json)
		set(POSTBUILD_FW_TZ		${sdk_prj_example_root}/GCC-RELEASE/mp/amebapro2_firmware_tz.json)
		set(POSTBUILD_KEY_CFG	${sdk_prj_example_root}/GCC-RELEASE/mp/key_cfg.json)
		set(POSTBUILD_CERT		${sdk_prj_example_root}/GCC-RELEASE/mp/certificate.json)
		set(POSTBUILD_PART		${sdk_prj_example_root}/GCC-RELEASE/mp/amebapro2_partitiontable.json)
		set(POSTBUILD_NNMDL		${sdk_prj_example_root}/GCC-RELEASE/mp/amebapro2_nn_model.json)
		set(POSTBUILD_FWFS_NN	${sdk_prj_example_root}/GCC-RELEASE/mp/amebapro2_fwfs_nn_models.json)
		
		set(POSTBUILD_ENC_BOOT	${sdk_prj_example_root}/GCC-RELEASE/mp/encrypt_bl.json)
		set(POSTBUILD_ENC_FW	${sdk_prj_example_root}/GCC-RELEASE/mp/encrypt_fw.json)
		
		set(POSTBUILD_ISP_IQ   	    ${sdk_prj_example_root}/GCC-RELEASE/mp/amebapro2_isp_iq.json)
		set(POSTBUILD_SENSOR_SET    ${sdk_prj_example_root}/GCC-RELEASE/mp/amebapro2_sensor_set.json)
