...
typedef enum MetricEvent
{
    ...
    /* Profiling Case - Signaling Message Delivery. */
    METRIC_EVENT_RECEIVE_SDP_OFFER_TO_CALLBACK,
    METRIC_EVENT_SEND_SDP_ANSWER,
    METRIC_EVENT_RECEIVE_SEND_SDP_ANSWER_INTO_QUEUE,
    METRIC_EVENT_RECEIVE_BASE64_ENCODE_SDP_ANSWER,
    METRIC_EVENT_RECEIVE_CONSTRUCT_WSS_MSG_SDP_ANSWER,
    METRIC_EVENT_RECEIVE_WSS_SEND_SDP_ANSWER,
    METRIC_EVENT_RECEIVE_TRIGGER_SDP_ANSWER_SIGNAL,
    METRIC_EVENT_RECEIVE_SDP_OFFER_TO_WSLAY_EXIT,
