...
#define PEER_CONNECTION_SRTP_CONVERT_TIME_US_TO_RTP_TIMESTAMP( clockRate, presentationUs ) (uint32_t)( (double) presentationUs * ((double) clockRate / PEER_CONNECTION_SRTP_US_IN_A_SECOND) )
